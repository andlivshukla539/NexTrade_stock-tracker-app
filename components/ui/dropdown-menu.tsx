...
type ContentVariant = "default" | "dark"
...
>(({ className, variant = "default", ...props }, ref) => (
  <DropdownMenuPrimitive.SubContent
    ...
    className={cn(
      ...
      variant === "dark" &&
      "!bg-black !text-white !opacity-100 shadow-2xl rounded-xl p-2 border border-white/20 overflow-hidden",
...
>(({ className, inset, ...props }, ref) => (
  <DropdownMenuPrimitive.Item
    ref={ref}
    className={cn(
      "relative flex cursor-default select-none items-center rounded-sm px-2 py-1.5 text-sm outline-none transition-colors focus:bg-white/10 focus:text-white data-[disabled]:pointer-events-none data-[disabled]:opacity-50 !bg-black",
      inset && "pl-8",
      className
    )}
    {...props}
